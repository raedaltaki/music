...
export default {
  install(app) {
    ...
    defineRule('counrty_excluded', excluded);
    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          email: `The field ${ctx.field} mus be a valid email.`,
          min_value: `The field ${ctx.field} is too low.`,
          max_value: `The field ${ctx.field} is too high.`,
          excluded: `You are not allowed to use this value for the field ${ctx.field}`,
          counrty_excluded: 'Due to restriction, we do not accept users from this location.',
